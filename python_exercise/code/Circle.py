...
def point_in_circle(point, circle):
    ...
    """
    dis = distance_between_points(point, circle.center)
    print(dis)
...
def main():
    ...
    print('point_in_circle',point_in_circle(box.corner, circle))
    print('rect_in_circle',rect_in_circle(box, circle))
    print('rect_circle_overlap',rect_circle_overlap(box, circle))
